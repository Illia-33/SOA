...
func (p *testRepoProvider) Accounts() repo.AccountsRepo {
	return accountsRepo{
		ctx:   context.Background(),
		scope: p.scope,
	}
...
func (p *testRepoProvider) Profiles() repo.ProfilesRepo {
	return profilesRepo{
		ctx:   context.Background(),
		scope: p.scope,
	}
...
func (p *testRepoProvider) ApiTokens() repo.ApiTokensRepo {
...
func (p *testRepoProvider) Outbox() repo.OutboxRepo {
	return outboxRepo{
		ctx:   context.Background(),
		scope: p.scope,
	}
